...
export default function GridTimeline() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-50 to-slate-100">
      
      {/* FIXED: pointer-events-none added here */}
      ...
      <div className="relative z-10 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className=" text-xl lg:text-5xl font-bold bg-gradient-to-r from-slate-600 via-gray-700 to-stone-600 bg-clip-text text-transparent mb-6">
            ...
            {timelineData.map((item, idx) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center">
                  <div className={`w-14 h-14 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center text-white text-xl mb-6 shadow-md`}>
                    {item.icon}
                  </div>

                  <div className="flex items-center gap-3 mb-4">
                    <span className="px-3 py-1 text-black text-xs font-bold rounded-full shadow-sm bg-white">
                      {item.year}
                    </span>
